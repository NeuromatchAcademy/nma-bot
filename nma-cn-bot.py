...
discordToken = 'OTkzNjUyNjQ0MjE0MjEwNTcw.G7HZvP.zk5TmZw_t37lSasYNPYnbbstGIAe5NMOqwLkn0'
...
sheet = shClient.open("compneuromastersheet").sheet1
records_data = sheet.get_all_records()
df = pd.DataFrame.from_dict(records_data)

projSheet = shClient.open("compneuromastersheet").get_worksheet(1)
...
staffIndex = [855972293486313530, 855972293486313529]
timezoneRoles = {
    "A": 856931228993060875, # americas
    "B": 856931206935347200, # europe-africa
    "C": 856931154773803058, # asia-pacific
}
probDict = {}
chanDict = {}
onbTicks = []
        ...
        if message.author != self.user or message.content.startswith("--csrun "):
                    ...
                    try:
                        ...
                        if (
                            any(
                                ...
                                for x in [855972293486313530, 855972293486313529]
                            )
                            == True
                        ):
                        ...
                        if message.author.id not in probDict.keys():
                            ...
                            if probDict[message.author.id] == 2:
                                ...
                                suppRole = guild.get_role(855972293486313529)
            ...
            if message.content.startswith(
                ...
                if cmd.startswith(
                    ...
                    zoomies = shClient.open("cn_zoom2022").sheet1
                    ...
                    try:
                        for eachUser in guild.members:
                            if guild.get_role(855972293472550914) in eachUser.roles:
                                continue
