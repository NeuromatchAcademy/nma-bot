...
discordToken = 'OTkzNjUxNDAwMDI4NDU1MDIy.Gyarud.igDj1eJ2CpggJs33RBRv2aTw_zzUlC3AeQz2Jk'
...
sheet = shClient.open("deeplearnmastersheet").sheet1
records_data = sheet.get_all_records()
df = pd.DataFrame.from_dict(records_data)

projSheet = shClient.open("deeplearnmastersheet").get_worksheet(1)
...
staffIndex = [867751492417355836, 867751492417355835] # List of staff role IDs.
timezoneRoles = {
